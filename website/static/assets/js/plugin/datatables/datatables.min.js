...
!(function (t) {
    ...
    if (n)
      for (i = n.length - 1; 0 <= i; i--) {
        ...
        for (t.isArray(p) || (p = [p]), l = 0, s = p.length; l < s; l++)
          ...
          else if ('string' == typeof p[l]) for (u = 0, c = h.length; u < c; u++) ('_all' == p[l] || t(h[u].nTh).hasClass(p[l])) && o(u, d);
      }
      ...
      var n = function (e, r, o) {
        ...
        for (var l, s, u = 0, c = o.length - 1; u < c; u++) {
          if (((l = o[u].match(ce)), (s = o[u].match(fe)), l)) {
            if (((o[u] = o[u].replace(ce, '')), (e[o[u]] = []), (i = o.slice()).splice(0, u + 1), (l = i.join('.')), t.isArray(r))) for (s = 0, c = r.length; s < c; s++) (i = {}), n(i, r[s], l), e[o[u]].push(i);
            else e[o[u]] = r;
            return;
          }
  ...
  function R(e, n, r, o) {
    var i,
      ...
      g = function (e) {
        (r !== a && r !== f) ||
          ((l = d[f]), (s = t.trim(e.innerHTML)), l && l._bAttrSrc ? (x(l.mData._)(o, s), p(l.mData.sort, e), p(l.mData.type, e), p(l.mData.filter, e)) : h ? (l._setter || (l._setter = x(l.mData)), l._setter(o, s)) : (o[f] = s)),
          f++;
      };
  ...
  function P(e, a, r, o) {
    var i,
      ...
      h = [];
    if (null === f.nTr) {
      for (i = r || n.createElement('tr'), f.nTr = i, f.anCells = h, i._DT_RowIndex = a, j(e, f), u = 0, c = e.aoColumns.length; u < c; u++)
        (s = e.aoColumns[u]),
          ((l = r ? o[u] : n.createElement(s.sCellType))._DT_CellIndex = { row: a, column: u }),
          h.push(l),
  ...
  function j(e, n) {
    ...
    if (a) {
      var o = e.rowIdFn(r);
      o && (a.id = o),
        r.DT_RowClass && ((o = r.DT_RowClass.split(' ')), (n.__rowc = n.__rowc ? se(n.__rowc.concat(o)) : o), t(a).removeClass(n.__rowc.join(' ')).addClass(r.DT_RowClass)),
  ...
  function H(e) {
    ...
    for (u && (o = t('<tr/>').appendTo(l)), n = 0, a = f.length; n < a; n++)
      (i = f[n]),
        ...
        u && r.appendTo(o),
        e.oFeatures.bSort && (r.addClass(i.sSortingClass), !1 !== i.bSortable && (r.attr('tabindex', e.iTabIndex).attr('aria-controls', e.sTableId), Tt(e, i.nTh, n))),
    ...
    if (-1 !== t.inArray(!1, n)) ft(e, !1);
      ...
      if (0 !== c.length)
        ...
        (r = l.sZeroRecords),
          ...
          (n[0] = t('<tr/>', { class: i ? o[0] : '' }).append(t('<td />', { valign: 'top', colSpan: b(e), class: e.oClasses.sRowEmpty }).html(r))[0]);
      Nt(e, 'aoHeaderCallback', 'header', [t(e.nTHead).children('tr')[0], I(e), s, f, c]),
      ...
      if (((i = null), '<' == (l = d[h]))) {
        if (((s = t('<div/>')[0]), "'" == (u = d[h + 1]) || '"' == u)) {
          ...
          'H' == c ? (c = n.sJUIHeader) : 'F' == c && (c = n.sJUIFooter),
            -1 != c.indexOf('.') ? ((u = c.split('.')), (s.id = u[0].substr(1, u[0].length - 1)), (s.className = u[1])) : '#' == c.charAt(0) ? (s.id = c.substr(1, c.length - 1)) : (s.className = c),
            (h += f);
        }
        o.append(s), (o = t(s));
    ...
    for (o = 0, s = h.length; o < s; o++)
      for (r = (a = h[o]).firstChild; r; ) {
        if ('TD' == r.nodeName.toUpperCase() || 'TH' == r.nodeName.toUpperCase()) {
          ...
          for (u = i, d = 1 === c, l = 0; l < c; l++) for (i = 0; i < f; i++) (e[o + i][u + l] = { cell: r, unique: d }), (e[o + i].nTr = a);
        }
        r = r.nextSibling;
      }
  }
  ...
  function V(e) {
    ...
    for (n = 0; n < l; n++)
      (r = i[n]),
        ...
        p.columns.push({ data: a, name: r.sName, searchable: r.bSearchable, orderable: r.bSortable, search: { value: o.sSearch, regex: o.bRegex } }),
        h('mDataProp_' + n, a),
        s.bFilter && (h('sSearch_' + n, o.sSearch), h('bRegex_' + n, o.bRegex), h('bSearchable_' + n, r.bSearchable)),
  ...
  function q(e) {
    var a = e.oClasses,
      ...
      c =
        ((a = t('<div/>', { id: l.f ? null : r + '_filter', class: a.sFilter }).append(t('<label/>').append(u))),
        (l = function () {
          var t = this.value ? this.value : '';
          t != i.sSearch && (G(e, { sSearch: t, bRegex: i.bRegex, bSmart: i.bSmart, bCaseInsensitive: i.bCaseInsensitive }), (e._iDisplayStart = 0), k(e));
        }),
  ...
  function G(t, e, n) {
    ...
    if ((m(t), 'ssp' != Mt(t))) {
      for (Y(t, e.sSearch, n, e.bEscapeRegex !== a ? !e.bEscapeRegex : e.bRegex, e.bSmart, e.bCaseInsensitive), i(e), e = 0; e < o.length; e++)
    ...
    for (e = !1, n = 0, r = t.aoData.length; n < r; n++)
      if (((s = t.aoData[n]), !s._aFilterData)) {
        for (i = [], a = 0, o = u.length; a < o; a++)
          (e = u[a]),
            e.bSearchable ? ((l = _(t, n, a, 'filter')), c[e.sType] && (l = c[e.sType](l)), null === l && (l = ''), 'string' != typeof l && l.toString && (l = l.toString())) : (l = ''),
  ...
  function et(e) {
    ...
    return a || (e.aoDrawCallback.push({ fn: nt, sName: 'information' }), r.attr('role', 'status').attr('aria-live', 'polite'), t(e.nTable).attr('aria-describedby', n + '_info')), r[0];
  }
  function nt(e) {
  ...
  function lt(e) {
    for (
      var n = e.oClasses, a = e.sTableId, r = e.aLengthMenu, o = (i = t.isArray(r[0])) ? r[0] : r, i = ((r = i ? r[1] : r), t('<select/>', { name: a + '_length', 'aria-controls': a, class: n.sLengthSelect })), l = 0, s = o.length;
      l < s;
      l++
    )
      ...
      (s = t('<div/>', { class: o.sScrollWrapper })
        .append(
          t('<div/>', { class: o.sScrollHead })
            .css({ overflow: 'hidden', position: 'relative', border: 0, width: a ? (a ? vt(a) : null) : '100%' })
            .append(
        ...
        .append(
          t('<div/>', { class: o.sScrollBody })
            .css({ position: 'relative', overflow: 'auto', width: a ? vt(a) : null })
            .append(f)
        )),
      c &&
        s.append(
          t('<div/>', { class: o.sScrollFoot })
            .css({ overflow: 'hidden', border: 0, width: a ? (a ? vt(a) : null) : '100%' })
            .append(
    ...
    (r = m.scrollHeight > m.clientHeight),
      e.scrollBarVis !== r && e.scrollBarVis !== a
        ...
        : ((e.scrollBarVis = r),
          ...
          I && ((o = I.clone().prependTo(T)), (n = I.find('tr')), (o = o.find('tr'))),
          ...
          (d = T.outerWidth()),
          '' === s
            ? ((x.width = '100%'), F && (T.find('tbody').height() > m.offsetHeight || 'scroll' == v.css('overflow-y')) && (x.width = vt(T.outerWidth() - f)), (d = T.outerWidth()))
          ...
          T.outerWidth() < d
            ? ((n = m.scrollHeight > m.offsetHeight || 'scroll' == v.css('overflow-y') ? d + f : d),
              F && (m.scrollHeight > m.offsetHeight || 'scroll' == v.css('overflow-y')) && (x.width = vt(n - f)),
              ('' === s || '' !== u) && Lt(e, 1, 'Possible column misalignment', 6))
            : (n = '100%'),
          (D.width = vt(n)),
          (g.width = vt(n)),
          ...
          I && ((_[0].style.width = vt(s)), (y[0].style.width = vt(s)), (y[0].style[c] = u ? f + 'px' : '0px')),
  ...
  function gt(n) {
    ...
    if (y || (!v && !s && !l && c == b(n) && c == d.length)) for (a = 0; a < c; a++) (f = p(n, a)), null !== f && (i[f].sWidth = vt(d.eq(a).width()));
    else {
      (c = t(o).clone().css('visibility', 'hidden').removeAttr('id')).find('tbody tr').remove();
      var _ = t('<tr/>').appendTo(c.find('tbody'));
      for (c.find('thead, tfoot').remove(), c.append(t(n.nTHead).clone()).append(t(n.nTFoot).clone()), c.find('tfoot th, tfoot td').css('width', ''), d = E(n, c.find('thead')[0]), a = 0; a < f.length; a++)
        (r = i[f[a]]), (d[a].style.width = null !== r.sWidthOrig && '' !== r.sWidthOrig ? vt(r.sWidthOrig) : ''), r.sWidthOrig && s && t(d[a]).append(t('<div/>').css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
      ...
      for (
        t('[name]', c).removeAttr('name'),
          r = t('<div/>')
            ...
            .append(c)
            .appendTo(m),
          s && u ? c.width(u) : s ? (c.css('width', 'auto'), c.removeAttr('width'), c.width() < m.clientWidth && g && c.width(m.clientWidth)) : l ? c.width(m.clientWidth) : g && c.width(g),
          a = l = 0;
        a < f.length;
        a++
      )
        (m = t(d[a])), (u = m.outerWidth() - m.width()), (m = D.bBounding ? Math.ceil(d[a].getBoundingClientRect().width) : m.outerWidth()), (l += m), (i[f[a]].sWidth = vt(m - u));
  ...
  function Dt(e) {
    ...
    for (
      ...
      for (n = 0, r = (o = c[(s = f[e][0])].aDataSort).length; n < r; n++)
        (i = o[n]), (l = c[i].sType || 'string'), f[e]._idx === a && (f[e]._idx = t.inArray(f[e][1], c[i].asSorting)), u.push({ src: s, col: i, dir: f[e][1], index: f[e]._idx, type: l, formatter: qt.ext.type.order[l + '-pre'] });
    return u;
  }
  function yt(t) {
    var e,
  ...
  function _t(t) {
    for (var e, n, a = t.aoColumns, r = Dt(t), o = ((t = t.oLanguage.oAria), 0), i = a.length; o < i; o++) {
      ...
      s.removeAttribute('aria-sort'),
        n.bSortable && (0 < r.length && r[0].col == o ? (s.setAttribute('aria-sort', 'asc' == r[0].dir ? 'ascending' : 'descending'), (n = l[r[0].index + 1] || l[0])) : (n = l[0]), (e += 'asc' === n ? t.sSortAscending : t.sSortDescending)),
    ...
    'number' == typeof i[0] && (i = e.aaSorting = [i]),
      r && e.oFeatures.bSortMulti
        ? -1 !== (r = t.inArray(n, re(i, '0')))
          ? (null === (n = s(i[r], !0)) && 1 === i.length && (n = 0), null === n ? i.splice(r, 1) : ((i[r][1] = l[n]), (i[r]._idx = n)))
  ...
  function xt(t, e) {
    ...
    for (var o, i = qt.ext.type.order[a.sType + '-pre'], l = 0, s = t.aoData.length; l < s; l++)
      (a = t.aoData[l]), a._aSortData || (a._aSortData = []), (!a._aSortData[e] || r) && ((o = r ? n[l] : _(t, l, e, 'sort')), (a._aSortData[e] = i ? i(o) : o));
  }
  function It(e) {
  ...
  function Nt(e, n, a, r) {
    ...
    return (
      ...
      null !== a && ((n = t.Event(a + '.dt')), t(e.nTable).trigger(n, r), o.push(n.result)),
      o
    );
  }
  function kt(t) {
  ...
  function Wt(t, e) {
    ...
    return (
      e <= n
        ...
        : (t >= e - 1 - a ? (n = ie(e - (n - 2), e)) : ((n = ie(t - a + 2, t + a - 1)).push('ellipsis'), n.push(e - 1)), n.splice(0, 0, 'ellipsis'), n.splice(0, 0, 0)),
      (n.DT_el = 'span'),
      n
    );
  }
        ...
        this.each(function () {
          ...
          if ('table' != this.nodeName.toLowerCase()) Lt(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
            ...
            t.extend(A, qt.ext.classes, g.oClasses),
              _.addClass(A.sTable),
              I.iInitDisplayStart === a && ((I.iInitDisplayStart = g.iDisplayStart), (I._iDisplayStart = g.iDisplayStart)),
              null !== g.iDeferLoading && ((I.bDeferLoading = !0), (p = t.isArray(g.iDeferLoading)), (I._iRecordsDisplay = p ? g.iDeferLoading[0] : g.iDeferLoading), (I._iRecordsTotal = p ? g.iDeferLoading[1] : g.iDeferLoading));
            var F = I.oLanguage;
            ...
            if (
              (-1 !==
                ...
                ) && (t('tbody tr', this).removeClass(p.join(' ')), (I.asDestroyStripes = p.slice())),
              (p = []),
              0 !== (C = this.getElementsByTagName('thead')).length && (W(I.aoHeader, C[0]), (p = E(I))),
              null === g.aoColumns)
            )
              ...
              t(L[0])
                ...
                .each(function (t, e) {
                  ...
                  if (n.mData === t) {
                    ...
                    (null === r && null === o) || ((n.mData = { _: t + '.display', sort: null !== r ? t + '.@data-' + r : a, type: null !== r ? t + '.@data-' + r : a, filter: null !== o ? t + '.@data-' + o : a }), d(I, t));
                  }
                });
            }
            var P = I.oFeatures;
            p = function () {
              ...
              if (
                ...
                0 === n.length || 0 === n.children().length ? _.addClass(A.sNoFooter) : n.length > 0 && ((I.nTFoot = n[0]), W(I.aoFooter, I.nTFoot)),
                g.aaData)
              )
  ...
  (Vt = function (e, n) {
    ...
    (this.context = se(a)), n && t.merge(this, n), (this.selector = { rows: null, cols: null, opts: null }), Vt.extend(this, this, Se);
  }),
    (qt.Api = Vt),
    ...
    (Vt.register = Xt =
      function (e, n) {
        if (t.isArray(e)) for (var a = 0, r = e.length; a < r; a++) Vt.register(e[a], n);
        else {
          var o,
            i,
            l = e.split('.'),
          ...
          for (a = 0, r = l.length; a < r; a++) {
            ...
            u || ((u = { name: o, val: {}, methodExt: [], propExt: [] }), s.push(u)), a === r - 1 ? (u.val = n) : (s = i ? u.methodExt : u.propExt);
          }
        }
      }),
    ...
    Xt('page.info()', function () {
      ...
      var t = this.context[0],
        ...
        o = -1 === n;
      return { page: o ? 0 : Math.floor(e / n), pages: o ? 1 : Math.ceil(r / n), start: e, end: t.fnDisplayEnd(), length: n, recordsTotal: t.fnRecordsTotal(), recordsDisplay: r, serverSide: 'ssp' === Mt(t) };
    }),
  ...
  var De = function (e, n, r, o, i) {
    ...
    Ce = function (e, n) {
      ...
      if ('current' == o) for (a = e._iDisplayStart, r = e.fnDisplayEnd(); a < r; a++) i.push(l[a]);
  ...
  Xt('row().child()', function (e, n) {
    ...
    if (!0 === e) this.child.show();
      ...
      var o = r[0],
        ...
        l = function (e, n) {
          if (t.isArray(e) || e instanceof t) for (var a = 0, r = e.length; a < r; a++) l(e[a], n);
  ...
  Xt('columns()', function (e, n) {
    ...
    Xt('cells()', function (e, n, r) {
        ...
        return this.iterator('table', function (n) {
          ...
          return De(
            ...
            function (e) {
              ...
              if (null === e || e === a || r) {
                for (i = [], l = 0, s = g.length; l < s; l++) for (o = g[l], u = 0; u < m; u++) (c = { row: o, column: u }), r ? ((f = p[o]), e(c, _(n, o, u), f.anCells ? f.anCells[u] : null) && i.push(c)) : i.push(c);
                return i;
              }
      ...
      var o,
        ...
        d = this.iterator(
          'table',
          function (t, e) {
            for (o = [], i = 0, l = f[e].length; i < l; i++) for (s = 0, u = c[e].length; s < u; s++) o.push({ row: f[e][i], column: c[e][s] });
            return o;
          },
          1
        );
    ...
    Xt('search()', function (e, n, r, o) {
      ...
      return e === a
        ...
        : this.iterator('table', function (a) {
            a.oFeatures.bFilter && G(a, t.extend({}, a.oPreviousSearch, { sSearch: e + '', bRegex: null !== n && n, bSmart: null === r || r, bCaseInsensitive: null === o || o }), 1);
          });
    }),
    Jt('columns().search()', 'column().search()', function (e, n, r, o) {
      return this.iterator('column', function (i, l) {
        ...
        i.oFeatures.bFilter && (t.extend(s[l], { sSearch: e + '', bRegex: null !== n && n, bSmart: null === r || r, bCaseInsensitive: null === o || o }), G(i, i.oPreviousSearch, 1));
      });
    }),
    Xt('state()', function () {
      ...
      return (
        ...
        this.iterator('table', function (a) {
          ...
          (a.bDestroying = !0),
            ...
            c && l != c.parentNode && (f.children('tfoot').detach(), f.append(c)),
            (a.aaSorting = []),
            (a.aaSortingFixed = []),
            wt(a),
    ...
    t.extend(Ut, { afnFiltering: Ut.search, aTypes: Ut.type.detect, ofnSearch: Ut.type.search, oSort: Ut.type.order, afnSortData: Ut.order, aoFeatures: Ut.feature, oApi: Ut.internal, oStdClasses: Ut.classes, oPagination: Ut.pager }),
            ...
            b = function (n, a) {
              ...
              for (r = 0, i = a.length; r < i; r++)
                if (((S = a[r]), t.isArray(S))) (f = t('<' + (S.DT_el || 'div') + '/>').appendTo(n)), b(f, S);
                  ...
                  null !== u &&
                    (jt(
                      (f = t('<a>', { class: d.sPageButton + ' ' + c, 'aria-controls': e.sTableId, 'aria-label': p[S], 'data-dt-idx': g, tabindex: e.iTabIndex, id: 0 === o && 'string' == typeof S ? e.sTableId + '_' + S : null })
                        .html(u)
                        .appendTo(n)),
                      { action: S },
                      m
            ...
            t(e.nTable).on('order.dt.DT', function (t, o, i, l) {
              e === o &&
                ...
                n
                  ...
                  .addClass('asc' == l[t] ? r.sSortJUIAsc : 'desc' == l[t] ? r.sSortJUIDesc : a.sSortingClassJUI));
            });
        },
      },
    });
...
!(function (e) {
  ...
  return (
    e.extend(!0, o.defaults, { dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: 'bootstrap' }),
        ...
        w = function (t, n) {
          ...
          for (o = 0, s = n.length; o < s; o++)
            if (((p = n[o]), e.isArray(p))) w(t, p);
              ...
              c &&
                ((d = e('<li>', { class: b.sPageButton + ' ' + u, id: 0 === r && 'string' == typeof p ? a.sTableId + '_' + p : null })
                  .append(e('<a>', { href: '#', 'aria-controls': a.sTableId, 'aria-label': g[p], 'data-dt-idx': x, tabindex: a.iTabIndex, class: 'page-link' }).html(c))
                  .appendTo(t)),
